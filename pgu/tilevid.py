            ...
            for y in xrange(oy/th,my):
                if y >=0 and y < h:
                    ...
                    for x in xrange(ox/tw,mx+1):
                        if x >=0and x<w:
                    		if not brow[x]: blit(tiles[brow[x]].image,(xx,yy))
                    		if not trow[x]: blit(tiles[trow[x]].image,(xx,yy))
                            #arow[x]=0
                        xx += tw
                yy+=th
        else:
        ...
        if blayer != None:
            for y in xrange(oy/th,my):
                if y >=0 and y < h:
                    ...
                    for x in xrange(ox/tw,mx+1):
                        if x >=0and x<w:
                            if brow[x]: blit(tiles[brow[x]].image,(xx,yy))
                            if trow[x]: blit(tiles[trow[x]].image,(xx,yy))
                            arow[x]=0
                        xx += tw
                yy+=th
        else:
